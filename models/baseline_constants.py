...
MAIN_PARAMS = {
    "sent140": {"small": (10, 2, 2), "medium": (16, 2, 2), "large": (24, 2, 2)},
    "femnist": {"small": (30, 10, 2), "medium": (100, 10, 2), "large": (400, 20, 2)},
    "shakespeare": {"small": (6, 2, 2), "medium": (8, 2, 2), "large": (20, 1, 2)},
    "celeba": {"small": (30, 10, 2), "medium": (100, 10, 2), "large": (400, 20, 2)},
    "synthetic": {"small": (6, 2, 2), "medium": (8, 2, 2), "large": (20, 1, 2)},
    "reddit": {"small": (6, 2, 2), "medium": (8, 2, 2), "large": (20, 1, 2)},
}
...
MODEL_PARAMS = {
    ...
    "sent140.stacked_lstm": (0.15, 25, 2, 100),  # lr, seq_len, num_classes, num_hidden
